<script lang="ts">
    ...
    export let url: string, fetchOptions: object, transpileData: Function | undefined = undefined, pagination: IPaginated, filters: IFilter[], sorting: ISort[]
