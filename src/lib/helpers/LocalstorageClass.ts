import type { IColumnMetaData, ICustomStoreOptions, ITableOptions, IStored } from '../interfaces/Types'

// TODO: remove general store & load after refactoring is done
...
export default class LocalStorageOptions implements ICustomStoreOptions {
  ...
  load = (id: string, internalColumns?: IColumnMetaData[]): IStored => {
