...
<script lang="ts">
  ...
  let dataTableMatrix: DataTable,
    ...
    dataTableCustomAthena: DataTable
...
<article>
  ...
  <details>
    <summary>Table with a async function as a data source but with a custom class implemented and given to the table</summary>
    <sumary>Click the delete button and check the logs in the console, it should say it is a custom error</sumary>
    <DataTable
